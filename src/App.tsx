...
// import projects details
const SmartDeskAI = lazy(() => import("./pages/projects/SmartDeskAI"));
const AlzheimerRisk = lazy(() => import("./pages/projects/AlzheimerRisk"));
const FingerCounting = lazy(() => import("./pages/projects/FingerCounting"));
const BAE = lazy(() => import("./pages/projects/Bae"));
